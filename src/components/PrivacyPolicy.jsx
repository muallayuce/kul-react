...
const PrivacyPolicy = () => {
  return (
    <div className='privacypolicy'>
      ...
      <p>
        This Privacy Policy governs the manner in which Kul-Balam ("us", "we", or "our") collects, uses, maintains, and discloses information collected from users (each, a "User") of the [Your Website/App URL] website and any mobile applications ("Site" or "App"). This privacy policy applies to the Site and all products and services offered by [Your Website/App Name].
      </p>
